...
export const selectInventoryFileManagerOpen = (state: RootState) =>
  state.inventory.ui.fileManagerOpen
export const selectInventoryFileManagerForm = (state: RootState) =>
  state.inventory.ui.fileManagerForm
